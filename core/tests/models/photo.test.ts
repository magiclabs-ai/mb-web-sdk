...
describe("Photo", () => {
  test("photoAnalyzeTimeoutDelay", async () => {
    expect(photoAnalyzeTimeoutDelay(1)).toBe(10000);
    expect(photoAnalyzeTimeoutDelay(100)).toBe(10000);
    expect(photoAnalyzeTimeoutDelay(101)).toBe(15000);
    expect(photoAnalyzeTimeoutDelay(400)).toBe(15000);
    expect(photoAnalyzeTimeoutDelay(401)).toBe(20000);
    expect(photoAnalyzeTimeoutDelay(800)).toBe(20000);
    expect(photoAnalyzeTimeoutDelay(801)).toBe(30000);
  });
});
